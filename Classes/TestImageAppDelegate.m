...
#import "TestImageAppDelegate.h"

@implementation TestImageAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    // It's very important to set the contentSize.
	// This is something that cannot be set in IB
